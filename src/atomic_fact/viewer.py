...
<div class="main">
  <header style="display:flex;flex-direction:column;align-items:flex-start;padding:16px 0;border-bottom:1px solid var(--border);margin-bottom:24px">
    <h1 style="font-size:20px;font-weight:600;color:var(--accent)">\u269b {title}</h1>
    <p class="report-source">Generated by: Benjamin Horvath's <a href="https://github.com/benhorvath/atomic_fact" target="_blank" rel="noopener noreferrer">atomic_fact</a> repository</p>
  </header>
...
.report-source{{font-size:13px;color:var(--text-muted);margin-top:6px;line-height:1.4}}
.report-source a{{color:var(--accent);text-decoration:none}}
